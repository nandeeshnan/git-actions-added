...
async function loginHandler(event) {
  ...
  try {
    const response = await fetch('http://acfd145e705b3465884abcfccfe5c14a-536035327.us-east-1.elb.amazonaws.com:8000/auth/login', {
      method: 'POST',
...
async function signupHandler(event) {
  ...
  try {
    const response = await fetch('http://acfd145e705b3465884abcfccfe5c14a-536035327.us-east-1.elb.amazonaws.com:8000/auth/signup', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ username, password })
    });
...
async function fetchRecipesHandler() {
  ...
  try {
    const response = await fetch('http://acfd145e705b3465884abcfccfe5c14a-536035327.us-east-1.elb.amazonaws.com:8000/api/recipes', {
      method: 'POST',
      headers: {
...
async function saveRecipe(recipe) {
  try {
    const response = await fetch('http://acfd145e705b3465884abcfccfe5c14a-536035327.us-east-1.elb.amazonaws.com:8000/api/save', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer ' + localStorage.getItem('token')
...
async function fetchSavedRecipes() {
  try {
    const response = await fetch('http://acfd145e705b3465884abcfccfe5c14a-536035327.us-east-1.elb.amazonaws.com:8000/api/saved', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer ' + localStorage.getItem('token')
...
async function deleteSaved(savedId) {
  try {
    const response = await fetch(`http://acfd145e705b3465884abcfccfe5c14a-536035327.us-east-1.elb.amazonaws.com:8000/api/saved/${savedId}`, {
      method: 'DELETE',
